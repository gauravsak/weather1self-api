...
import com.equalexperts.weather1self.client.response.WeatherResponse;
...
public class OpenWeatherMapClient {
    ...
    private static final String API_URL = "api.openweathermap.org/data/2.5";
    private static final String API_KEY = "a19d564d7f6db6df2c4d18a3c218131d";

    public List<WeatherDatum> getWeatherData(String city, String country, DateTime fromInstant, DateTime toInstant, String frequency)
